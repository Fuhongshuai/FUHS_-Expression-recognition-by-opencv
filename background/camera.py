...
image_height = 48
image_width = 48
img_dir = '/Users/fuhongshuai/PycharmProjects/face_recognition/GUI/test/'
predict_path = "/users/fuhongshuai/PycharmProjects/face_recognition/background/shape_predictor_68_face_landmarks.dat"
...
def operate_img(img):
    ...
    get_npy()
    model = joblib.load("/users/fuhongshuai/PycharmProjects/face_recognition/background/xg_model.bin")
    ...
    test_dict['Y'] = np.load('/Users/fuhongshuai/PycharmProjects/face_recognition/GUI/' + '/labels_test' + '.npy')
    test = test_dict
...
def video_face_recognition(camera_num=0):
    ...
    # landmark  dat
    predictor_path = "/users/fuhongshuai/PycharmProjects/face_recognition/background/shape_predictor_68_face_landmarks.dat"
    # 初始化landmark
